...
def compute_policy_loss_vanilla(
    ...
    if use_tokenwise_ratio_bounds:
        ...
        # print(f"use apply_soft_clip: soft_clip_methods={soft_clip_methods}, tokenwise_ratio_bounds_method: {tokenwise_ratio_bounds_method}")
        # print(f"True: use_tokenwise_ratio_bounds by tokenwise_ratio_bounds_method_{tokenwise_ratio_bounds_method} band_numerical_solver_{band_numerical_solver} band_use_log_domain_{band_use_log_domain}: {use_tokenwise_ratio_bounds}")
    else:
        ...
        # print(f"use apply_soft_clip: soft_clip_methods={soft_clip_methods}, use_tokenwise_ratio_bounds: {use_tokenwise_ratio_bounds}")
    print(
            f"use_tokenwise_ratio_bounds: {use_tokenwise_ratio_bounds} "
            f"({tokenwise_ratio_bounds_method if use_tokenwise_ratio_bounds else f'fixed=[1-{clip_ratio_low}, 1+{clip_ratio_high}]'}); "
