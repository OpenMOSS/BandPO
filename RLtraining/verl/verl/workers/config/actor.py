...
class ActorConfig(BaseConfig):
    ...
    clip_use_dual_clip: bool = True
    # use_tokenwise_trust_region_mapping_clip: bool = True
    use_tokenwise_ratio_bounds: bool = False
    tokenwise_ratio_bounds_method: str = "bandkl"
    does_relax_high_p_bound:  bool = False
    upper_bound_max: float = 100
    band_numerical_solver: str = "bisect"
    band_use_log_domain: bool = True
    band_radius_delta: float = 0.1
    use_soft_clip: bool = False
    soft_clip_methods: str = "hard"
    use_decaying_clip: bool = False
    decaying_clip_methods: str = "linear"
    decaying_clip_start_value: float = 0.2
    decaying_clip_end_value: float = 0.02
    delta_mapping_ratio_method: str = "sub" # "sub" 或 "div"
    use_one_minus_p_for_mapping_in_div: bool = True # 仅 method="div" 时有效
    mapping_eps: float = 1e-12
    mapping_ratio_min_cap: float = 1e-6
    mapping_ratio_max_cap: float = 1e6
    is_debug: bool = False
    debug_record_path: str = ""
    debug_clip_print_max_pairs: int = 256
