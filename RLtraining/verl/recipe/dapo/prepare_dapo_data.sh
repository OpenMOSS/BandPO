...
export TRAIN_FILE=${TRAIN_FILE:-"/remote-home1/yli/Workspace/BandPO/data/datasets/dapo/dapo-math-17k.parquet"}
export TEST_FILE=${TEST_FILE:-"/remote-home1/yli/Workspace/BandPO/data/datasets/aime2024/aime-2024.parquet"}
