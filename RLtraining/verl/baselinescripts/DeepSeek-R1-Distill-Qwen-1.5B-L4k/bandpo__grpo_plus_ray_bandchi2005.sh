...
# to modify
project_name="VERL_DapoMath_DeepSeekR1DistillQwen1.5B"
exp_name="bandpo__grpo_plus_ray_bandchi2005"
...
ray job submit --no-wait --runtime-env="${RUNTIME_ENV}" \
    ...
    +actor_rollout_ref.actor.tokenwise_ratio_bounds_method="bandchi2" \
