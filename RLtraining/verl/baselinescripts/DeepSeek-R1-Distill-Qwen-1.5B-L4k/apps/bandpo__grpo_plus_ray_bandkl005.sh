...
apps_train=$BandPODir/data/dataset/apps/train.parquet
apps_val=$BandPODir/data/dataset/apps/val_1k.parquet

# to modify
project_name="VERL_apps_DeepSeekR1DistillQwen1.5B"
exp_name="bandpo__grpo_plus_ray_bandkl005"
model_path="$BandPODir/data/models/deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B"

max_prompt_length=$((1024 * 2))
max_response_length_real=$((1024 * 3))
...
ray job submit --no-wait --runtime-env="${RUNTIME_ENV}" \
    ...
    data.train_files="['$apps_train']" \
    data.val_files="['$apps_val']" \
