...
# exp_name="grpo_plus_ray_trgppo005_tokenmean" # no dual-clip, no clip higher
exp_name="grpo_plus_ray_trgppo005_tokenmean_test" # no dual-clip, no clip higher
exp_name="grpo_plus_ray_trgppo005_test" # no dual-clip, no clip higher
...
loss_agg_mode="seq-mean-token-mean" # "seq-mean-token-mean" 
rollout_record_path="$BandPODir/data/records/${project_name}/${exp_name}/sample_traces.jsonl"
mkdir -p "$(dirname "$rollout_record_path")"
: > "$rollout_record_path"
rollout_record_detail=true
