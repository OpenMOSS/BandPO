...
exp_name="dapo_official" # no dual-clip, no clip higher
...
max_response_length_real=$((1024 * 4)) # 没有overlong_buffer_len的要设置为这个: (1024 * 20)->(1024 * 8)
overlong_buffer_len=$((512 * 1)) # 评测时，一开始模型会多了这512个token会高一些，所以要以grpo的结果为准
