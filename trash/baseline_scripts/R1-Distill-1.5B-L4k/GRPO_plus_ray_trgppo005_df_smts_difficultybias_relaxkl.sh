...
exp_name="grpo_plus_ray_trgppo005_df_smts_difficultybias_relaxkl" # no dual-clip, no clip higher
...
loss_agg_mode="seq-mean-token-sum" # "token-mean" #  "seq-mean-token-mean"
...
# # rambling filter
# rambling_filter_url="http://10.176.59.108:8000" # 如果希望在配置层面关闭 filter，可以在这里设为空字符串：""
