...
exp_name="grpo_plus_ray_trgppo005_tokenmean_fixed_by_kl001" # no dual-clip, no clip higher
...
records_dir="$BandPODir/data/records/${project_name}/${exp_name}"
mkdir -p "$records_dir"
...
# rambling_filter_url="http://10.176.59.103:8000" # 如果希望在配置层面关闭 filter，可以在这里设为空字符串：""
...
resume_from_path="/remote-home1/yli/Workspace/BandPO/data/ckpts/RLtraining_DapoMathDataset_DeepseekR1_1.5B/grpo_plus_ray_trgppo005_tokenmean_test/global_step_400"
...
ray job submit --no-wait --runtime-env="${RUNTIME_ENV}" \
    ...
    +actor_rollout_ref.actor.kl_delta=0.01 \
