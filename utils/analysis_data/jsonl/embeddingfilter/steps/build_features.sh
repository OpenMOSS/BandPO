...
# OUT_DIR="$BandPODir/data/records/RLtraining_DapoMathDataset_DeepseekR1_1.5B/grpo_plus_ray_trgppo01_tokenmean_df/build_features_steps"
...
# # Stage2: sentence embedding（在 GPU 机器上跑这个脚本时偏好）
# echo "[RUN] Stage2: compute sentence embeddings"
# python build_features_embedding_hf.py \
...
# echo "[RUN] Stage3: analysis with embeddings"
...
#   --preprocess-dir "$OUT_DIR" \
#   --embed-dir "$OUT_DIR" \
#   --out-dir "$OUT_DIR/onlycorrectkept" \
#   --procs 120 \
#   --dup-threshold 0.90 \
#   --cluster-threshold 0.85 \
#   --only-kept \
